...
We need to know for each client "how much important" it is for the company
All data should be scoped over current year except charts that compare current year data v/s previous year
...
rename payroll -> payslip
rationalize modules
introduce usequery/usemutation
Our ui should have a brutalist style
Switch prettier with biome
