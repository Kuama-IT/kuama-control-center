...
export default function BrutalUIShowcase() {
    ...
    const brutalClasses = {
        ...
        input: "bg-white border-6 border-black text-black text-xl font-bold px-6 py-6 focus:outline-none focus:ring-0 focus:border-red-500 transition-all duration-200 shadow-[8px_8px_0px_0px_#333333] focus:shadow-[12px_12px_0px_0px_#333333] focus:translate-x-[-2px] focus:translate-y-[-2px] rounded-none",
        checkbox:
        ...
        calendar: {
            ...
            head_row: "",
            head_cell:
                "text-black font-black uppercase text-sm text-center p-2",
            row: "",
        ...
        command: {
            ...
            input: "border-0 border-b-4 border-black px-6 py-4 font-bold text-lg focus:outline-none rounded-none bg-white",
        ...
        dropdown: {
            ...
            label: "px-4 py-2 font-black uppercase text-sm tracking-wider bg-gray-100",
        },
        dateRangePicker: {
            container:
        ...
        header: "font-black text-4xl md:text-6xl uppercase tracking-tighter leading-none",
                            ...
                            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex space-x-4">
                                        ...
                                        <Button
                                            className={
                                                brutalClasses.button.secondary
                                            }
                                        >
                                            RESET
                                        </Button>
                        ...
                        <div className={brutalClasses.card}>
                            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <Button
                                            className={`${brutalClasses.button.danger} w-full`}
                                        >
                                            DELETE
                                        </Button>
                                        <Button
                ...
                {selectedTab === "INTERACTIVE" && (
                    <div className="space-y-8">
                            ...
                            <div className="flex justify-center">
                                <Calendar
                                    ...
                                    classNames={{
                                        ...
                                        caption_label:
                                            brutalClasses.calendar
                                                .caption_label,
                                        nav: brutalClasses.calendar.nav,
                                        nav_button:
                                            brutalClasses.calendar.nav_button,
                                        nav_button_previous:
                                            brutalClasses.calendar
                                                .nav_button_previous,
                                        nav_button_next:
                                        ...
                                        head_row:
                                            brutalClasses.calendar.head_row,
                                        head_cell:
                                            brutalClasses.calendar.head_cell,
                                        row: brutalClasses.calendar.row,
                                        cell: brutalClasses.calendar.cell,
                                        day: brutalClasses.calendar.day,
                                        day_selected:
                                            brutalClasses.calendar.day_selected,
                                        day_today:
                                            brutalClasses.calendar.day_today,
                                        day_outside:
                                            brutalClasses.calendar.day_outside,
                                        day_disabled:
                                            brutalClasses.calendar.day_disabled,
                                        day_range_middle:
                                            brutalClasses.calendar
                                                .day_range_middle,
                                        day_hidden:
                                            brutalClasses.calendar.day_hidden,
                                    }}
                                />
                            </div>
                        </div>
                        ...
                        <div className={brutalClasses.card}>
                            ...
                            <Command
                                className={brutalClasses.command.container}
                            >
                                <CommandInput
                        ...
                        <div className={brutalClasses.card}>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <Dialog>
                                    ...
                                    <DialogContent
                                        className={brutalClasses.dialog.content}
                                    >
                                        <DialogHeader>
                                            <DialogTitle
                                                className={
                                                    brutalClasses.dialog.title
                                                }
                                            >
                                                BRUTAL DIALOG
                                            </DialogTitle>
                                            <DialogDescription
                                                className={
                                                    brutalClasses.dialog
                                                        .description
                                                }
                                            >
                                                This is a brutalist-styled
                                                dialog with sharp edges, high
                                                contrast, and bold typography.
                                                No rounded corners, no subtle
                                                shadows - just pure, functional
                                                design.
                                            </DialogDescription>
                                        </DialogHeader>
                            ...
                            <div className="space-y-4">
                                <p className="font-bold text-lg">
                                    ...
                                    <HoverCard>
                                        <HoverCardTrigger
                                            className={
                                                brutalClasses.hoverCard.trigger
                                            }
                                        >
                                            BRUTAL DESIGN
                                        </HoverCardTrigger>
                                        <HoverCardContent
                                            className={
                                                brutalClasses.hoverCard.content
                                            }
                                        >
                        ...
                        <div className={brutalClasses.card}>
                            ...
                            <div className="flex flex-wrap gap-6">
                                <div className="text-center">
                                    <Avatar
                                        className={
                                            brutalClasses.avatar.container
                                        }
                                    >
                ...
                {selectedTab === "ADVANCED" && (
                    <div className="space-y-8">
                        ...
                        <div className={brutalClasses.card}>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent
                                        className={
                                            brutalClasses.dropdown.content
                                        }
                                    >
                                        <DropdownMenuLabel
                                            className={
                                                brutalClasses.dropdown.label
                                            }
                                        >
                                            ACTIONS
                                        </DropdownMenuLabel>
                                        <DropdownMenuSeparator
                                            className={
                                                brutalClasses.dropdown.separator
                                            }
                                        />
                                        <DropdownMenuItem
                                            className={
                        ...
                        <div className={brutalClasses.card}>
                            ...
                            <div className="space-y-4">
                                <p className="font-bold text-lg">
                                    Click buttons to trigger brutal-styled toast
                                    notifications:
                                </p>
                                <div className="flex flex-wrap gap-4">
                                    <Button
                            ...
                            <div className="space-y-6">
                                <div className="border-4 border-gray-600 bg-black p-6 font-mono text-green-400 text-sm">
                                    ...
                                    <div className="space-y-1">
                                        <div>
                                            &gt; INITIALIZING BRUTAL UI
                                            COMPONENTS...
                                        </div>
                                        <div>
                                            &gt; LOADING GEOMETRIC FRAMEWORKS...
                                            OK
                                        </div>
                                        <div>
                                            &gt; APPLYING CONTRAST FILTERS... OK
                                        </div>
                                        <div>
                                            &gt; SETTING TYPOGRAPHY WEIGHTS...
                                            OK
                                        </div>
                                        <div>
                                            &gt; ENABLING SHADOW SYSTEMS... OK
                                        </div>
                                        <div>
                                            &gt; BRUTAL DESIGN SYSTEM READY
                                        </div>
                                        <div className="mt-4">
                    ...
                    <div className="mx-auto max-w-2xl">
                        ...
                        <div className="space-y-4 font-mono text-gray-600">
                            <p className="uppercase tracking-wider">
                                "FORM FOLLOWS FUNCTION, STRIPPED OF ALL
