                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>
                                The external tracker platform to import data
                                from.
                            </FormDescription>
                            <FormMessage />
                        </FormItem>
                        ...
                        render={({ field: { onChange, value } }) => {
                            ...
                            return (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Projects related to these credentials
                                        (optional)
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                        ...
                        render={({ field: { onChange, value } }) => {
                            ...
                            return (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Employee related to these credentials
                                        (optional)
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>
                                The api endpoint to be used in order to read
                                spent time.
                            </FormDescription>
                            <FormMessage />
                        </FormItem>
