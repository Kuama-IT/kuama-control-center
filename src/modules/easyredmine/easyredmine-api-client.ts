...
export class EasyRedmineApiClient {
  ...
  async getSpentTimes(date: Date) {
    ...
    const req = await fetch(
      `${this.endpoint}/time_entries.json?set_filter=true&f[spent_on]=${formattedStartOfMonth}|${formattedEndOfMonth}&f[user_id]=${encodeURI("=me")}`,
      {
        headers: {
