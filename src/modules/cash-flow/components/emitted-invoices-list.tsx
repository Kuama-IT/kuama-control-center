...
export function EmittedInvoicesList({ from, to }: { from: Date; to: Date }) {
  ...
  const query = useEmittedInvoicesQuery({ from: selectedFrom, to: selectedTo });
  ...
  if (query.isLoading) {
    return (
      <div className="flex items-center justify-center p-8">
        <div className="text-muted-foreground">Loading emitted invoices...</div>
      </div>
    );
  }
          ...
          >
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold text-lg">
                    {invoice.entity?.name || "Unknown Client"}
                  </h3>
                </div>
            ...
            <div
              className={`grid grid-cols-1 gap-4 mb-4 ${
                invoice.amount_vat !== null && invoice.amount_vat !== undefined
                  ? "md:grid-cols-3"
                  : "md:grid-cols-2"
              }`}
            >
              ...
              <>
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <Badge variant="secondary">
                    {format(
                      new Date(invoice.payments_list[0].due_date),
                      "dd/MM/yyyy"
                    )}
                  </Badge>
                </div>
